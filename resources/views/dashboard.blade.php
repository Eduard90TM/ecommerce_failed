    ...
    <div class="dashboard-ecommerce">
        <div class="container-fluid dashboard-content">
            ...
            <div class="row">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="m-r-10">
                                                    <img src="assets/images/{{ $order->gallery }}" alt="user" class="rounded"
                                                        width="45">
                                                </div>
                                            </td>
                                            <td>{{ $order->name }}</td>
                                            ...
                                            <td><span
                                                    class="badge-dot mr-1 @if($order->delivery_status == 'in progress') {{ 'badge-brand' }}
                                                             @elseif($order->delivery_status == 'delivered') {{ 'badge-success' }} @else {{ 'badge-danger' }} @endif "></span>{{ $order->delivery_status }}
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        <h5 class="card-header">Customers Order Chart</h5>
                        <div class="card-body">
            ...
            <div class="modal fade" id="add-product" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
                aria-hidden="true">
                <!-- ... (modal content) ... -->
            </div>
        </div>
