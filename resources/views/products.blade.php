        ...
        <div class="col-md-5 my-4">
            <div class="product shadow-lg rounded bg-secondary product-details" style="border-color: rgb(230, 230, 248);">
                <div class="image-hover">
                    <img class="card-img-top shadow rounded" id="product-image"
                        src="{{ asset('assets/images/' . $product['gallery']) }}" alt="trending product"
                        style="object-fit: cover; height: 355px; min-height: 280px;">
                </div>
            </div>
        </div>
        <div class="col-md-6 my-4">
            <div class="card-body shadow-lg rounded">
                ...
                <form action="{{ route('add.cart') }}" method="POST">
                    ...
                    <button type="button" @if(Session::has('user')) onclick="add_to_cart(this)" @else
                        onclick="window.location.href='/login'" @endif
                        class="add-to-cart-btn my-3 btn btn-warning">Add to Cart</button><br>
                </form>
