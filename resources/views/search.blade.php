...
<div class="container-fluid trending">
    <h4 class="text-center text-secondary my-4">Searched Products</h4>
    <div class="row">
        @if (!empty($products))
            ...
            <a href="{{ url('product', $product['id']) }}">
                <div class="card shadow searched-product" style="background-color: transparent; border-color: rgb(230, 230, 248);">
                    <div class="image-hover">
                        <img class="card-img-top" height="250px" src="{{ url('assets/images', $product['gallery']) }}" alt="searched product">
                    </div>
                    <div class="card-body">
